...
public enum EnumExpression implements IEnumExpression {
    EXPR_STMT   ("<CREATE>|<CALL_FUNC>|<MODIFY>", false),
    FACTOR      ("<EXPR_STMT>|<ANON_FUNC>|<FUNC_POINTER>|<ACCESS>|STRING|CHAR|HEX_NUMBER|NUMBER|TRUE|FALSE|OPEN_PRNTH<EXPRESSION>CLOSE_PRNTH"),
    NEGATION    ("?<CAST> ?NOT <FACTOR>"),
